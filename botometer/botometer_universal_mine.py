...
# import data
df = pd.read_csv(r"C:\Users\amber\Desktop\account_status\dominion\user_2023-06-10.csv")

list_of_handles = df.loc[df['status'].str.contains("Active")]
list_of_handles = ['@' + handle.strip().lower() for handle in list_of_handles['username']]
...
bom = botometer.Botometer(
    ...
    rapidapi_key='85d8c98d8emsh73f6d22851cf11ap108f3djsn447254edb8d4', # find link to set up botometer in the lines above
  **twitter_app_auth)
...
final.to_csv('botometer_{}.csv'.format(current_date))